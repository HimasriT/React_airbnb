            ...
            <div class="card" id={p.id} style={{ marginBottom: 5 + 'em', minHeight: 24 + 'em' }} >
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        No.of bedrooms :{p.bedrooms}<br>
                        </br>
                        Amenities : {p.amenities}<br>
                        </br>
                        Per night fee :{p.night_fee}<br>
                        </br>
                        Cleaning fee for stay : {p.cleaning_fee}<br>
                        </br>
                        Service fee for stay : {p.service_fee}<br>
                        </br>
                        Property description : {p.description}<br>
                        </br>
                    </p>
                </div>
            </div>
